    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_xml_nfe', models.FileField(blank=True, null=True, upload_to=nfe.models.upload_file_nfe)),
                ('url_pdf_nfe', models.FileField(blank=True, null=True, upload_to=nfe.models.upload_file_nfe)),
                ('url_xml_cancelado', models.FileField(blank=True, null=True, upload_to=nfe.models.upload_file_nfe)),
                ('url_pdf_cancelado', models.FileField(blank=True, null=True, upload_to=nfe.models.upload_file_nfe)),
                ('url_xml_carta_correcao', models.FileField(blank=True, null=True, upload_to=nfe.models.upload_file_nfe)),
                ('url_pdf_carta_correcao', models.FileField(blank=True, null=True, upload_to=nfe.models.upload_file_nfe)),
